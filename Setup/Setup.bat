...
powershell.exe -Command "(New-Object System.Net.WebClient).DownloadFile('C:\Users\david\source\repos\THREDrSetup\THREDrDB-v1.0.3.zip', '%TEMP%\THREDrDB-v1.0.3.zip')" || goto :Error
