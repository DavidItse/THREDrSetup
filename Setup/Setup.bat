...
powershell.exe -Command "(New-Object System.Net.WebClient).DownloadFile('C:\Users\david\source\repos\THREDrSetup\THREDrDB-v1.0.0.3.zip', '%TEMP%\THREDrDB-v1.0.0.3.zip')" || goto :Error
echo Extracting update...
powershell.exe -Command "Expand-Archive -Path '%TEMP%\THREDrDB-v1.0.0.3.zip' -DestinationPath 'C:\Users\david\AppData\Roaming\ThredrDB' -Force" || goto :Error
echo Cleaning up...
del "%TEMP%\THREDrDB-v1.0.0.3.zip" > nul 2>&1
